...
// -----------------------------------------------------------------------------
// Single-threaded cooperative model (FreeRTOS tasks removed)
// Navigation handled by NavigationController with proper stack
// Input handled by InputHandler with consistent console/TV-style controls
